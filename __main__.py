...
try:
    ...
    while main_loop:
        try:
            ...
            print(f"[FAILED] {format(e)}")
            print("SECURITY REMINDER! COLORAMA REQUIRED...")
            print("For more information: https://pypi.org/project/colorama/")

            sub_loop = True
            while sub_loop:
                choice = input("Would you like to install colorama? [y|n] : ").lower()

                if choice.strip() == "y" or choice.strip() == "yes":
                    sub_loop = False

                    print("[ INFO ] Installing colorama...")
        ...
        try:
            ...
            while sub_loop0:
                try:
                    ...
                    print(colorama.Fore.RED + "[FAILED] Failed to initialize pyttsx3...")
                    ...
                    if operating_system == "Linux":
                        ...
                        sub_loop1 = True
                        while sub_loop1:
                            choice = input(colorama.Fore.RED + "Would you like to install espeak & alsa-utils? [y|n] : "
                    ...
                    print(colorama.Fore.RED + "[FAILED] Failed to initialize...")
                    print(colorama.Fore.RED + f"[FAILED] {format(e)}")
                    print("Exiting...")
                    exit()
            ...
            print(colorama.Fore.RED + f"[FAILED] {format(e)}")
            print(colorama.Fore.RED + "SECURITY REMINDER! PYTTSX3 REQUIRED...")
            print("For more information: https://pypi.org/project/pyttsx3/")

            sub_loop = True
            while sub_loop:
                choice = input(colorama.Fore.RED +
                ...
                if choice.strip() == "y" or choice.strip() == "yes":
                    ...
                    print(colorama.Fore.YELLOW + "[ INFO ] Installing pyttsx3...")
                    ...
                    print(colorama.Fore.YELLOW + "[ INFO ] Invalid choice, Please try again...")
    ...
    while main_loop:
        try:
            ...
            print(colorama.Fore.RED + f"[FAILED] {format(e)}")
            print(colorama.Fore.RED + "SECURITY REMINDER! SpeechRecognition REQUIRED...")
            print("For more information: https://pypi.org/project/SpeechRecognition/")

            sub_loop = True
            while sub_loop:
                choice = input(colorama.Fore.RED +
                               "Would you like to install SpeechRecognition? [y|n] : " +
                               colorama.Style.RESET_ALL).lower()

                if choice.strip() == "y" or choice.strip() == "yes":
                    sub_loop = False

                    print(colorama.Fore.YELLOW + "[ INFO ] Installing SpeechRecognition...")
    ...
    while main_loop:
        try:
            ...
            print(colorama.Fore.RED + f"[FAILED] {format(e)}")
            print(colorama.Fore.RED + "SECURITY REMINDER! URLLIB3 REQUIRED...")
            print("For more information: https://pypi.org/project/urllib3/")

            sub_loop = True
            while sub_loop:
                choice = input(colorama.Fore.RED +
                               "Would you like to install urllib3? [y|n] : " +
                               colorama.Style.RESET_ALL).lower()

                if choice.strip() == "y" or choice.strip() == "yes":
                    sub_loop = False

                    print(colorama.Fore.YELLOW + "[ INFO ] Installing urllib3...")
    ...
    while main_loop:
        try:
            ...
            print(colorama.Fore.RED + f"[FAILED] {format(e)}")
            print(colorama.Fore.RED + "SECURITY REMINDER! CHARDET REQUIRED...")
            print("For more information: https://pypi.org/project/chardet/")

            sub_loop = True
            while sub_loop:
                choice = input(colorama.Fore.RED +
                               "Would you like to install chardet? [y|n] : " +
                               colorama.Style.RESET_ALL).lower()

                if choice.strip() == "y" or choice.strip() == "yes":
                    sub_loop = False

                    print(colorama.Fore.YELLOW + "[ INFO ] Installing chardet...")
                    pip.main(["install", "chardet"])
                    print(colorama.Fore.GREEN + "Done...")

                elif choice == "n" or choice.strip() == "no":
                    sub_loop = False
                    print("Exiting...")
                    exit()
    ...
    while main_loop:
        try:
            ...
            print(colorama.Fore.RED + f"[FAILED] {format(e)}")
            print(colorama.Fore.RED + "SECURITY REMINDER! CERTIFI REQUIRED...")
            print("For more information: https://pypi.org/project/certifi/")

            sub_loop = True
            while sub_loop:
                choice = input(colorama.Fore.RED +
                               "Would you like to install certifi? [y|n] : " +
                               colorama.Style.RESET_ALL).lower()

                if choice.strip() == "y" or choice.strip() == "yes":
                    sub_loop = False

                    print(colorama.Fore.YELLOW + "[ INFO ] Installing certifi...")
