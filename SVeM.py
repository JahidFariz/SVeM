...
try:
    ...
    print(colorama.Fore.YELLOW + "[ INFO ] Importing os...")
    import os

    print(colorama.Fore.GREEN + "[  OK  ] os imported successfully...")

    print(colorama.Fore.YELLOW + "[ INFO ] Importing platform...")
    import platform

    print(colorama.Fore.GREEN + "[  OK  ] platform imported successfully...")
